...
export default class QueryManager {
	 ...
	 * @param  {Object}         options Options for receive, notably `patch` or
	 *                                  `query`
	 * @return {QueryManager}           Same instance if no modifications have
	 *                                  been made, or a new instance otherwise
	 */
