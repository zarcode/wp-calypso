...
module.exports = React.createClass( {
	...
	componentDidMount: function() {
		...
		tinymce.init( {
			...
			toolbar1: 'wpcom_insert_menu,wpcom_add_media,formatselect,bold,italic,bullist,numlist,link,blockquote,alignleft,aligncenter,alignright,spellchecker,wp_more,wpcom_add_contact_form,wpcom_advanced',
